...
// // Spin up an instance of the app and returns its address for testing
// // including http://
// async fn spawn_app() -> TestApp {
//     // The first tine `initializeg` is invoked the code in `TRACING` is executed.
//     // All other invocations will isntead skip the execution.
//     Lazy::force(&TRACING);
...
//     // Migrate new temporary database
